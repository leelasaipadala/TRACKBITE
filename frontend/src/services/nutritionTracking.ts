...
const defaultState: NutritionState = {
  entries: [
    { id: 'demo1', mealType: 'Breakfast', name: 'Oats with Berries & Protein', servingSize: '1 bowl', calories: 450, protein: 32, carbs: 55, fat: 10, fiber: 8, sugar: 9, sodium: 110, potassium: 320, calcium: 150, iron: 2.5, vitaminA: 40, vitaminC: 15, vitaminD: 1.0, favorite: true, createdAt: new Date().toISOString() },
    { id: 'demo2', mealType: 'Lunch', name: 'Grilled Chicken Quinoa Bowl', servingSize: '1 plate', calories: 580, protein: 48, carbs: 45, fat: 16, fiber: 7, sugar: 4, sodium: 420, potassium: 510, calcium: 60, iron: 3.2, vitaminA: 180, vitaminC: 22, vitaminD: 0, favorite: true, createdAt: new Date().toISOString() },
    { id: 'demo3', mealType: 'Evening Snack', name: 'Greek Yogurt & Almonds', servingSize: '1 cup', calories: 220, protein: 18, carbs: 14, fat: 9, fiber: 3, sugar: 8, sodium: 80, potassium: 290, calcium: 210, iron: 0.6, vitaminA: 90, vitaminC: 2, vitaminD: 1.2, favorite: false, createdAt: new Date().toISOString() },
    { id: 'demo4', mealType: 'Dinner', name: 'Salmon with Roasted Vegetables', servingSize: '1 plate', calories: 610, protein: 42, carbs: 30, fat: 22, fiber: 6, sugar: 5, sodium: 490, potassium: 620, calcium: 90, iron: 2.1, vitaminA: 240, vitaminC: 35, vitaminD: 4.5, favorite: true, createdAt: new Date().toISOString() }
  ],
  water: 2250,
  weight: 68,
  bodyFat: 21.5,
  ...
  streakCount: 14,
  longestStreak: 21,
  lastStreakUpdateDate: new Date().toISOString().slice(0, 10),
